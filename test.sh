...
docker exec -it cassandra cqlsh -e "insert into test.timestamps (id,stamps,times) values (uuid(),{'produced':123488492, 'consumed':987654321}, [{'produced':223488491}, {'consumed': 887654322}]);"
